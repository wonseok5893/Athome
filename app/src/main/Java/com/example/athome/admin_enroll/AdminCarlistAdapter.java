...
//    private List<AdminCarlistData> data = null;
//    private int layout;
//
//    //생성자
//    public AdminCarlistAdapter(Context context, int layout, List<AdminCarlistAdapter> data)
//    {
//        this.inflater=(LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
//        this.data = (List<AdminCarlistData>) data;
//        this.layout=layout;
//    }
//
//    //화면 갱신되기전 호출
...
//        }
//
//        Admin itemNoticeData=data.get(position);
//
