...
public class AdminUserClickedSharePastAdapter extends BaseAdapter {
    LayoutInflater inflater = null;
    private ArrayList<AdminUserClickedShareData> data = null;
    private int layout;

    //생성자
    public AdminUserClickedSharePastAdapter(Context context, int layout, ArrayList<AdminUserClickedShareData> data)
    {
